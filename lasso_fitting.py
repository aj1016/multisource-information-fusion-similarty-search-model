...
lamb = 1.5
linear_regressor = Lasso(alpha=lamb)
...
df.to_csv('process data/lasso_weight data.csv', index=False)
...
df.to_csv('process data/lasso_fitting accuracy.csv', index=False)