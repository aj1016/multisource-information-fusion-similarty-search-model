...
print('Start testing......')
df_data = pd.read_csv('process data/multi-source_hydrology_fitting.csv')
k = 1
name = []
test_name = []
distance_space = []
...
data.to_csv('process data/multi-source_spatiotemporal_fitting.csv', index=False, header=False)