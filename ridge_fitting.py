...
'''The regrssion of ridge'''
lamb = 1.5
linear_regressor = Ridge(alpha=lamb)
...
df.to_csv('process data/ridge_weight data.csv', index=False)
...
df.to_csv('process data/ridge_fitting accuracy.csv', index=False)